...
import com.example.intelligencetest.databinding.FragmentTitleBinding;
...
public class TitleFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        binding= DataBindingUtil.inflate(inflater,R.layout.fragment_title,container,false);       //fragment用inflate绑定
        ...
        return binding.getRoot();              //根节点是view类
